  ...
  methods: {
    ...
    validateExpressions (expressions) {
      expressions.forEach((expression) => {
        ...
        this.validateRequiredBaseTypeAndCardinality(qtiAttributeValidation.validateOutcomeIdentifierAttribute(teststore, this.identifier), expression.component.proxy)
      })
    },
