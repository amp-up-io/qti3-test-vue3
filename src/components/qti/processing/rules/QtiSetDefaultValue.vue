...
export default {
  ...
  methods: {
    ...
    validateExpressions (expressions) {
      expressions.forEach((expression) => {
        ...
        this.validateRequiredBaseTypeAndCardinality(qtiAttributeValidation.validateVariableIdentifierAttribute(teststore, this.identifier), expression.component.proxy)
      })
    },
    ...
    evaluate () {
      try {
        ...
        teststore.setVariableDefaultValue({
  ...
  created () {
    try {
      qtiAttributeValidation.validateVariableIdentifierAttribute(teststore, this.identifier)
