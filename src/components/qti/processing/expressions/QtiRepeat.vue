  ...
  methods: {
    ...
    validateAttributes() {
      ...
      try {
        ...
        const declarationNumberRepeats = qtiAttributeValidation.validateTemplateOrOutcomeIdentifierAttribute(teststore, this.numberRepeats)
    ...
    getNumberRepeatsValue () {
      ...
      let declaration = teststore.getVariableDeclaration(this.numberRepeats)
