...
export default {
  ...
  methods: {
    ...
    getFieldBaseTypeFromRecordVariable (variableIdentifier) {
      ...
      try {
        variableDeclaration = qtiAttributeValidation.validateVariableIdentifierAttribute(teststore, variableIdentifier)
      } catch (err) {
      ...
      try {
        variableDeclaration = qtiAttributeValidation.validateResponseIdentifierAttribute (teststore, variableIdentifier)
      } catch (err) {
