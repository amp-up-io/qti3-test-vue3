  ...
  methods: {
    ...
    validateAttributes() {
      ...
      try {
        ...
        const declarationN = qtiAttributeValidation.validateTemplateOrOutcomeIdentifierAttribute(teststore, this.n)
    ...
    getNValue () {
      ...
      let declaration = teststore.getVariableDeclaration(this.n)
