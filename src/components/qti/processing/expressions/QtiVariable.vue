...
export default {
  ...
  methods: {
    ...
    evaluate () {
      try {
        let declaration = qtiAttributeValidation.validateVariableIdentifierAttribute (teststore, this.identifier)
  ...
  created () {
    try {
      let variableDeclaration = qtiAttributeValidation.validateVariableIdentifierAttribute(teststore, this.identifier)
