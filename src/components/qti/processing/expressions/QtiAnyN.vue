...
export default {
  ...
  methods: {
    ...
    validateMinMaxAttribute(attributeName, attributeValue) {
      ...
      try {
        declaration =  qtiAttributeValidation.validateVariableIdentifierAttribute(teststore, attributeValue)
    ...
    getMinValue () {
      ...
      let declaration = teststore.getVariableDeclaration(this.min)
    ...
    getMaxValue () {
      ...
      let declaration = teststore.getVariableDeclaration(this.max)
      // Return the variable's value.  Return 0 if variable is somehow not found.
      return (declaration !== null ? declaration.value : 0)
    }
  },
